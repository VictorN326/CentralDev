  ...
  return (
    <div className="relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center">
      ...
      <Select onValueChange={(value) => handleUpdateParams(value)}>
        ...
        <SelectContent className="body-semibold text-dark500_light700  max-h-[350px] max-w-[250px] bg-light-900 dark:bg-dark-300 cursor-pointe">
          <SelectGroup>
            {countriesList ? (
              countriesList.map((country: Country) => (
                <SelectItem
                  ...
                  className="px-4 py-3 hover:bg-light-800 dark:hover:bg-dark-400"
                >
                  {country.name.common}
                </SelectItem>
              ))
